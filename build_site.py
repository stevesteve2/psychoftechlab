...
<section style="padding-top:28px">
  <div class="wrap">
    ...
    <div class="video-grid">
      ...
      <figure class="vid">
        <iframe src="https://www.youtube.com/embed/gqqNwbSF49Y?start=745" title="Hypercommunication appearance 1" allowfullscreen loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
        <figcaption><b>Hypercommunication</b></figcaption>
      </figure>
      <figure class="vid">
        <iframe src="https://www.youtube.com/embed/QqFkGhDovF8?start=1426" title="Hypercommunication appearance 2" allowfullscreen loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
        <figcaption><b>Hypercommunication</b></figcaption>
      </figure>
    </div>
    <div class="section-head"><h2 style="font-size:26px">Science communication TikTok account (<a href="https://www.tiktok.com/@stevepsychology" target="_blank" rel="noopener">@stevepsychology</a>) with more than 1 million followers</h2></div>
    ...
    <ul class="media-list" style="padding-left:0;margin-bottom:56px">
      ...
      <li><b><a href="https://freakonomics.com/podcast/why-is-u-s-media-so-negative/" target="_blank" rel="noopener">Why Is U.S. Media So Negative?</a></b> <span>— Freakonomics (2021)</span></li>
